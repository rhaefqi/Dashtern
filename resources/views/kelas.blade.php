    ...
    <div class="grid grid-cols-1 gap-4 mt-6">
        <a href="tugas" class="block bg-white rounded-xl shadow p-4 hover:bg-gray-100 transition">
            <div class="flex items-center space-x-4">
                <img src="{{ asset('images/logo-universitas.png') }}" alt="Logo Universitas" class="w-12 h-12 object-contain">
                <div>
        ...
        <a href="tugas" class="block bg-white rounded-xl shadow p-4 hover:bg-gray-100 transition">
            <div class="flex items-center space-x-4">
                <img src="{{ asset('images/logo-universitas.png') }}" alt="Logo Universitas" class="w-12 h-12 object-contain">
                <div>
                    <h2 class="text-xl font-bold">Universitas Pembangunan Pancabudi</h2>
                </div>
            </div>
        </a>
