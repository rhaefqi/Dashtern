    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white flex flex-col items-center py-6 shadow-md">
            ...
            <nav class="w-full px-4 space-y-4">
                <a href="{{ url('/beranda') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->is('beranda') || request()->is('/*') ? 'bg-[#145A5A] text-white shadow' : 'text-black hover:bg-gray-100' }}">
                ...
                <a href="/progres"  class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->is('progres') ? 'bg-[#145A5A] text-white shadow' : 'text-black hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
                ...
                <a href="/panduan"  class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->is('panduan') ? 'bg-[#145A5A] text-white shadow' : 'text-black hover:bg-gray-100' }}">
                ...
                <a href="/tentang"  class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->is('tentang') ? 'bg-[#145A5A] text-white shadow' : 'text-black hover:bg-gray-100' }}">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd"
