    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-white flex flex-col items-center py-6 shadow-md">
            ...
            <nav class="w-full px-4 space-y-4">
                <a href="#" class="flex items-center space-x-3 px-4 py-3 bg-[#145A5A] text-white rounded-lg shadow">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10 2L2 8v10a1 1 0 001 1h5V12h4v7h5a1 1 0 001-1V8l-8-6z" />
                    </svg>
                    <span>Beranda</span>
                </a>
                <a href="#" class="flex items-center space-x-3 px-4 py-3 text-black hover:bg-gray-100 rounded-lg">
